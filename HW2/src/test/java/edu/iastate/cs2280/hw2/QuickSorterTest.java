...
class QuickSorterTest {
    ...
    /**
     * Test Case #1: Tests the quick sorting algorithm with an empty list of students as in input,
    ...
    public void quickSortWithEmptyArray(){
        ...
        assertThrows(IllegalArgumentException.class, () -> {
            new QuickSorter(testArrayEmpty);
        });
    ...
    /**
     * Test Case #2: Tests that the quick sorting algorithm by GPA with a student list containing only 1 element
     * will keep the singular student element.
     */
    @Test public void quickSortByGpaWithOneElemArray(){

        //Assigns testSorter to a new QuickSorter object, passing in testArrayOne
        testSorter = new QuickSorter(testArrayOne);
    ...
    /**
     * Test Case #3: Tests that the quick sorting algorithm by credits with a student list containing only 1 element
     * will keep the singular student element.
     */
    @Test public void quickSortByCreditsWithOneElemArray(){
    ...
    /**
     * Test Case #4: Tests that the quick sorting algorithm by GPA with a student list with an odd length
     * will properly sort the array descendingly.
     */
    @Test
    public void quickSortByGPAWithOddArray(){
        ...
        //Assigns testSorter to a new QuickSorter object, passing in testArrayOdd
        testSorter = new QuickSorter(testArrayOdd);
    ...
    /**
     * Test Case #5: Tests that the quick sorting algorithm by credits with a student list with an odd length
     * will properly sort the array ascendingly.
     */
    @Test
    public void quickSortByCreditsWithOddArray(){
    ...
    /**
     * Test Case #6: Tests that the quick sorting algorithm by gpa with a SORTED student list with an odd length
     * will properly sort the array descendingly.
     */
    @Test
    public void quickSortByGpaWithOddSortedArray(){
        ...
        //Assigns testSorter to a new QuickSorter object, passing in testArrayOddSorted
        testSorter = new QuickSorter(testArrayOddSorted);
    ...
    /**
     * Test Case #7: Tests that the quick sorting algorithm by credits with a SORTED student list with an odd length
     * will properly sort the array ascendingly.
     */
    @Test
    public void quickSortByCreditsWithOddSortedArray(){
    ...
    /**
     * Test Case #8: Tests that the quick sorting algorithm by GPA with a REVERSE-SORTED student list with an
     * odd length will properly sort the array descendingly.
     */
    @Test
    public void quickSortByGPAWithOddReverseSortedArray(){
        ...
        //Assigns testSorter to a new QuickSorter object, passing in testArrayOddReverseSorted
        testSorter = new QuickSorter(testArrayOddReverseSorted);
    ...
    /**
     * Test Case #9: Tests that the quick sorting algorithm by credits with a REVERSE-SORTED student list with an
     * odd length will properly sort the array ascendingly.
     */
    @Test
    public void quickSortByCreditsWithOddReverseSortedArray(){
        ...
        //Assigns testSorter to a new QuickSorter object, passing in testArrayOddReversedSorted
        testSorter = new QuickSorter(testArrayOddReverseSorted);
    ...
    /**
     * Test Case #10: Tests that the quick sorting algorithm by GPA with a student list with an
     * even length will properly sort the array descendingly.
     */
    @Test
    public void quickSortByGPAWithEvenArray(){
        ...
        //Assigns testSorter to a new QuickSorter object, passing in testArrayEven
        testSorter = new QuickSorter(testArrayEven);
    ...
    /**
     * Test Case #11: Tests that the quick sorting algorithm by credits with a student list with an
     * even length will properly sort the array ascendingly.
     */
    @Test
    public void quickSortByCreditsWithEvenArray(){
    ...
    /**
     * Test Case #12: Tests that the quick sorting algorithm by GPA with a SORTED student list with an
     * even length will properly sort the array descendingly.
     */
    @Test
    public void quickSortByGPAWithEvenSortedArray(){
        ...
        //Assigns testSorter to a new QuickSorter object, passing in testArrayEvenSorted
        testSorter = new QuickSorter(testArrayEvenSorted);
    ...
    /**
     * Test Case #13: Tests that the quick sorting algorithm by credits with a SORTED student list with an
     * even length will properly sort the array ascendingly.
     */
    @Test
    public void quickSortByCreditsWithEvenSortedArray(){
        ...
        //Assigns testSorter to a new quickSort object, passing in testArrayEvenSorted
        testSorter = new QuickSorter(testArrayEvenSorted);
    ...
    /**
     * Test Case #14: Tests that the quick sorting algorithm by GPA with a REVERSE-SORTED student list with an
     * even length will properly sort the array descendingly.
     */
    @Test
    public void quickSortByGPAWithEvenReverseSortedArray(){
        ...
        //Assigns testSorter to a new QuickSorter object, passing in testArrayEvenReverseSorted
        testSorter = new QuickSorter(testArrayEvenReverseSorted);
    ...
    /**
     * Test Case #15: Tests that the quick sorting algorithm by credits with a REVERSE-SORTED student list with an
     * even length will properly sort the array descendingly.
     */
    @Test
    public void quickSortByCreditsWithEvenReverseSortedArray(){
    ...
    /**
     * Test Case #16: Tests that an IllegalArgumentException will be thrown upon attempting to construct QuickSorter
     * object with a null array.
     */
    @Test
    public void quickSortWithNullArray(){

        //Checks if constructing a QuickSorter object by passing in a null array throws an IllegalArgumentException
        assertThrows(IllegalArgumentException.class, () -> {
            new QuickSorter(testArrayNull);
        });
