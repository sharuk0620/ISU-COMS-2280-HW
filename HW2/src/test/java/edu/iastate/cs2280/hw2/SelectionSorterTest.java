...
class SelectionSorterTest {
    ...
    /**
     * Test Case #1: Tests the selection sorting algorithm with an empty list of students as in input,
     * seeing if it will return a IllegalArgumentException.
     */
    @Test
    public void selectSortWithEmptyArray(){
        //Checks to see if an IllegalArgument exception is thrown upon call to constructor
        assertThrows(IllegalArgumentException.class, () -> {
            new SelectionSorter(testArrayEmpty);
        });
    ...
    /**
     * Test Case #2: Tests that the selection sorting algorithm by GPA with a student list containing only 1 element
     * will keep the singular student element.
     */
    @Test public void selectSortByGpaWithOneElemArray(){

        //Assigns testSorter to a new SelectionSorter object, passing in testArrayOne
        testSorter = new SelectionSorter(testArrayOne);
    ...
    /**
     * Test Case #3: Tests that the selection sorting algorithm by credits with a student list containing only 1 element
     * will keep the singular student element.
     */
    @Test public void selectSortByCreditsWithOneElemArray(){
    ...
    /**
     * Test Case #4: Tests that the selection sorting algorithm by GPA with a student list with an odd length
     * will properly sort the array descendingly.
     */
    @Test
    public void selectSortByGPAWithOddArray(){
        ...
        //Assigns testSorter to a new SelectionSorter object, passing in testArrayOdd
        testSorter = new SelectionSorter(testArrayOdd);
    ...
    /**
     * Test Case #5: Tests that the selection sorting algorithm by credits with a student list with an odd length
     * will properly sort the array ascendingly.
     */
    @Test
    public void selectSortByCreditsWithOddArray(){
    ...
    /**
     * Test Case #6: Tests that the selection sorting algorithm by gpa with a SORTED student list with an odd length
     * will properly sort the array descendingly.
     */
    @Test
    public void selectSortByGpaWithOddSortedArray(){
        ...
        //Assigns testSorter to a new SelectionSorter object, passing in testArrayOddSorted
        testSorter = new SelectionSorter(testArrayOddSorted);
    ...
    /**
     * Test Case #7: Tests that the selection sorting algorithm by credits with a SORTED student list with an odd length
     * will properly sort the array ascendingly.
     */
    @Test
    public void selectSortByCreditsWithOddSortedArray(){
    ...
    /**
     * Test Case #8: Tests that the selection sorting algorithm by GPA with a REVERSE-SORTED student list with an
     * odd length will properly sort the array descendingly.
     */
    @Test
    public void selectSortByGPAWithOddReverseSortedArray(){
        ...
        //Assigns testSorter to a new SelectionSorter object, passing in testArrayOddReverseSorted
        testSorter = new SelectionSorter(testArrayOddReverseSorted);
    ...
    /**
     * Test Case #9: Tests that the selection sorting algorithm by credits with a REVERSE-SORTED student list with an
     * odd length will properly sort the array ascendingly.
     */
    @Test
    public void selectSortByCreditsWithOddReverseSortedArray(){
        ...
        //Assigns testSorter to a new SelectionSorter object, passing in testArrayOddReversedSorted
        testSorter = new SelectionSorter(testArrayOddReverseSorted);
    ...
    /**
     * Test Case #10: Tests that the selection sorting algorithm by GPA with a student list with an
     * even length will properly sort the array descendingly.
     */
    @Test
    public void selectSortByGPAWithEvenArray(){
        ...
        //Assigns testSorter to a new SelectionSorter object, passing in testArrayEven
        testSorter = new SelectionSorter(testArrayEven);
    ...
    /**
     * Test Case #11: Tests that the selection sorting algorithm by credits with a student list with an
     * even length will properly sort the array ascendingly.
     */
    @Test
    public void selectSortByCreditsWithEvenArray(){
    ...
    /**
     * Test Case #12: Tests that the selection sorting algorithm by GPA with a SORTED student list with an
     * even length will properly sort the array descendingly.
     */
    @Test
    public void selectSortByGPAWithEvenSortedArray(){
        ...
        //Assigns testSorter to a new SelectionSorter object, passing in testArrayEvenSorted
        testSorter = new SelectionSorter(testArrayEvenSorted);
    ...
    /**
     * Test Case #13: Tests that the selection sorting algorithm by credits with a SORTED student list with an
     * even length will properly sort the array ascendingly.
     */
    @Test
    public void selectSortByCreditsWithEvenSortedArray(){
        ...
        //Assigns testSorter to a new SelectionSort object, passing in testArrayEvenSorted
        testSorter = new SelectionSorter(testArrayEvenSorted);
    ...
    /**
     * Test Case #14: Tests that the selection sorting algorithm by GPA with a REVERSE-SORTED student list with an
     * even length will properly sort the array descendingly.
     */
    @Test
    public void selectSortByGPAWithEvenReverseSortedArray(){
        ...
        //Assigns testSorter to a new SelectionSorter object, passing in testArrayEvenReverseSorted
        testSorter = new SelectionSorter(testArrayEvenReverseSorted);
    ...
    /**
     * Test Case #15: Tests that the selection sorting algorithm by credits with a REVERSE-SORTED student list with an
     * even length will properly sort the array descendingly.
     */
    @Test
    public void selectSortByCreditsWithEvenReverseSortedArray(){
    ...
    /**
     * Test Case #16: Tests that an IllegalArgumentException will be thrown upon attempting to construct SelectionSorter
     * object with a null array.
     */
    @Test
    public void selectSortWithNullArray(){

        //Checks if constructing a SelectionSorter object by passing in a null array throws an IllegalArgumentException
        assertThrows(IllegalArgumentException.class, () -> {
            new SelectionSorter(testArrayNull);
        });
